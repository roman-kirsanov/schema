...
export type Schema<T = any> =
    ...
    T extends boolean ? SchemaBoolean : never |
    SchemaAny;
...
export const ISO_DATE_REGEXP: RegExp = /^\d{4}-(([0][0-9])|([1][012]))-(([012][1-9])|([3][01]))$/
export const ISO_DATE_HHMM_REGEXP: RegExp = /^\d{4}-(([0][0-9])|([1][012]))-(([012][0-9])|([3][01]))(T|\ )(([01][0-9])|([2][0-3]))\:[0-5][0-9]$/
export const ISO_DATE_HHMMSS_REGEXP: RegExp = /^\d{4}-(([0][0-9])|([1][012]))-(([012][0-9])|([3][01]))(T|\ )(([01][0-9])|([2][0-3]))\:[0-5][0-9]\:[0-5][0-9]$/
